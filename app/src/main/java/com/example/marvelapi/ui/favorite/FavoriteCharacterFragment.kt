...
import com.example.marvelapi.databinding.FragmentFavoriteCharacterBinding
...
private val characterAdapter by lazy{ CharacterAdapter() }
    ...
    private fun setupRecyclerView() = with(binding) {
        ...
        ItemTouchHelper(itemTouchHelperCallApp()).attachToRecyclerView(rvFavoriteCharacter)
    }

    private fun itemTouchHelperCallApp(): ItemTouchHelper.SimpleCallback {
        return object :
